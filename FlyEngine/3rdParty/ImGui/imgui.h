...
namespace ImGui
{
    ...
    IMGUI_API bool          ComboArray(const char* label, int* current_item, const char* const items[], int items_count, int popup_max_height_in_items = -1);
    ...
    IMGUI_API void          Columns(int count = 1, const char* id = NULL, bool border = false);
